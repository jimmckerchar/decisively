require "informers"
require "digest"
require_relative "decisive/version"
require_relative "decisive/decision"
require_relative "decisive/calibrator"
require_relative "decisive/engine"
require_relative "decisive/railtie" if defined?(Rails::Railtie)
...
module Decisive
  ...
  class Config
    ...
    def initialize
      ...
      @temperature         = 1.0   # set by Decisive.calibrate!
